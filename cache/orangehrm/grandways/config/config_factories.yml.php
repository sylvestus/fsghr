...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => 'D:\\xampp\\htdocs\\ohrm\\symfony\\log/orangehrm_grandways.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => 'D:\\xampp\\htdocs\\ohrm\\symfony\\cache\\orangehrm\\grandways\\i18n',
  'lifetime' => 31556926,
  'prefix' => 'D:\\xampp\\htdocs\\ohrm\\symfony\\apps\\orangehrm/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('PHPSESSID'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => 'D:\\xampp\\htdocs\\ohrm\\symfony\\cache\\orangehrm\\grandways\\template',
  'lifetime' => 86400,
  'prefix' => 'D:\\xampp\\htdocs\\ohrm\\symfony\\apps\\orangehrm/template',
)));
...
$this->setMailerConfiguration(array_merge(array('class' => sfConfig::get('sf_factory_mailer', 'sfMailer')), sfConfig::get('sf_factory_mailer_parameters', array (
  ...
  array (
    ...
    'param' => 
    array (
      'host' => 'mail.busgateway.is.co.za',
      'port' => 587,
      'encryption' => NULL,
      'username' => 'info@shiloahmega.com',
      'password' => 'MegaProps@2501',
    ),
  ),
))));
