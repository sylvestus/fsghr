...
//            if ($reqAccept) {
//                ?>
                <!--<p>Registration information was collected, and Succesfully sent to techsavanna.technology</p>-->
            <?php//} else { ?>
                <!--<p class="error">Registration information was collected, but NOT sent to techsavanna.technology, please click Retry to try again, or click Skip to proceed and login into OrangeHRM</p>-->
                <?php
//            }
//        }
