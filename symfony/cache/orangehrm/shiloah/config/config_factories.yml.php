...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/var/www/html/fgshr/symfony/log/orangehrm_shiloah.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/var/www/html/fgshr/symfony/cache/orangehrm/shiloah/i18n',
  'lifetime' => 31556926,
  'prefix' => '/var/www/html/fgshr/symfony/apps/orangehrm/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('PHPSESSID'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/var/www/html/fgshr/symfony/cache/orangehrm/shiloah/template',
  'lifetime' => 86400,
  'prefix' => '/var/www/html/fgshr/symfony/apps/orangehrm/template',
)));
...
$this->setMailerConfiguration(array_merge(array('class' => sfConfig::get('sf_factory_mailer', 'sfMailer')), sfConfig::get('sf_factory_mailer_parameters', array (
  ...
  array (
    ...
    'param' => 
    array (
      'host' => 'mail.techsavanna.technology',
      'port' => 465,
      'encryption' => 'ssl',
      'username' => 'info@techsavanna.technology',
      'password' => '$dkz3}?zV7jF',
    ),
  ),
))));
