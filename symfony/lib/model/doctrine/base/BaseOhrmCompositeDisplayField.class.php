 ...
 * @method OhrmCompositeDisplayField setOhrmReportGroup()                   Sets the current record's "OhrmReportGroup" value
 * @method OhrmCompositeDisplayField setOhrmDisplayFieldGroup()             Sets the current record's "OhrmDisplayFieldGroup" value
 * @method OhrmCompositeDisplayField setOhrmSelectedCompositeDisplayField() Sets the current record's "OhrmSelectedCompositeDisplayField" collection
 * 
 * @package    orangehrm
