 ...
 * @method integer             getHandover()         Returns the current record's "emp_number" value
 ...
 * @method Leave               setHandover()         Sets the current record's "emp_number" value
 ...
 * 
 * @package    orangehrm * @method Leave               setEndTime()           Sets the current record's "end_time" value
...
abstract class BaseLeave extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('emp_number', 'integer',10, array(
          ...
          $this->hasColumn('handover', 'integer',10, array(
             'type' => 'integer',
             'fixed' => 0,
             'unsigned' => false,
             'primary' => false,
