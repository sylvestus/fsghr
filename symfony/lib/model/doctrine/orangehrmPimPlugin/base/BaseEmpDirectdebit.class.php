 ...
 * @property string $account_type
  * @property integer $bankbranch
 * @property string $transaction_type
 * @property EmployeeSalary $salary
 * 
 * @method integer        getId()               Returns the current record's "id" value
   * @method integer        getEmpNumber()               Returns the current record's "id" value
 ...
 * @method string         getAccountType()      Returns the current record's "account_type" value
  * @method integer     getBankBranch()      Returns the current record's "account_type" value
 ...
 * @method EmpDirectdebit setId()               Sets the current record's "id" value
  * @method EmpDirectdebit setEmpNumber()               Sets the current record's "id" value
 ...
 * @method EmpDirectdebit setAccount()          Sets the current record's "account" value
  * @method EmpDirectdebit setBankBranch()          Sets the current record's "account" value
...
abstract class BaseEmpDirectdebit extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('salary_id', 'integer', 4, array(
          ...
          $this->hasColumn('dd_bankbranch as bankbranch', 'integer', 4, array(
             'type' => 'integer',
             'notnull' => true,
             'length' => 4,
             ));
