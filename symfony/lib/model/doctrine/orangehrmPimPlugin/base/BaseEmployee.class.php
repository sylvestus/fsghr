 ...
 * @method integer               getOnProbation()               Returns the current record's "emp_marital_status" value
 *   @method integer               getPayNssf()               Returns the current record's "emp_marital_status" value
 *   @method integer               getPayRelief()               Returns the current record's "emp_marital_status" value
  * @method integer               getPayNhif()               Returns the current record's "emp_marital_status" valu
 * @method integer              getPayTax()               Returns the current record's "emp_marital_status" valu
 *@method integer              getEncashLeave()               Returns the current record's "emp_marital_status" valu
 * @method string               getFixedTax()               Returns the current record's "emp_marital_status" valu
 * @method string                    getNickName()                   Returns the current record's "nickName" value
 * @method integer                   getPensionable()                     Returns the current record's "smoker" value
 ...
 * @method Employee                  setPensionable()                     Sets the current record's "smoker" value
 ...
 * @method Employee                  setTerminationId()              Sets the current record's "termination_id" value
  * @method Employee                  setOnProbation()              Sets the current record's "termination_id" value
   *  @method Employee         setPayNssf()                Sets the current record's "OhrmJobCategory" value
    * @method Employee         setPayNhif()                Sets the current record's "OhrmJobCategory" value
  * @method Employee               setFixedTax()               Returns the current record's "emp_marital_status" valu
    * @method Employee         setPayTax()                Sets the current record's "OhrmJobCategory" value
 * @method Employee         setEncashLeave()                Sets the current record's "OhrmJobCategory" value
  * @method Employee         setVehicleType()           Sets the current record's "vehicle_type" value
 * @method Employee         setVehicleValue()          Sets the current record's "vehicle_value" value
 * @method Employee         setVehicleBenefit()        Sets the current record's "vehicle_benefit" value
     * @method Employee         setPayRelief()                Sets the current record's "OhrmJobCategory" value
...
abstract class BaseEmployee extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('emp_pensionable as pensionable', 'integer', 2, array(
             'type' => 'integer',
             'default' => '0',
             'length' => 2,
             ));
        ...
        $this->hasColumn('emp_hm_telephone', 'string', 50, array(
          ...
          $this->hasColumn('on_probation', 'integer', 4, array(
             'type' => 'integer',
             'fixed' => 0,
             'unsigned' => false,
             'primary' => false,
         ...
         $this->hasColumn('fixed_tax', 'string', 25, array(
             'type' => 'string',
             'fixed' => 0,
             'unsigned' => false,
             'primary' => false,
