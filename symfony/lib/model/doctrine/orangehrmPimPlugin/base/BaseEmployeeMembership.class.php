 ...
 * @method string             getMembNumber()       Returns the current record's "subscriptionPaidBy" value
 ...
 * @method EmployeeMembership setMembNumber()          Sets the current record's "subscriptionFee" value
...
abstract class BaseEmployeeMembership extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('memb_number', 'string', 30, array(
             'type' => 'string',
             'default' => '',
             'length' => 30,
             ));
