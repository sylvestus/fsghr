 ...
 * @method string           getMinSalary()    Returns the current record's "minSalary" value
 * @method string           getMaxSalary()    Returns the current record's "maxSalary" value
...
abstract class BasePayGradeCurrency extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('min_salary as minSalary', 'string', 255, array(
             'type' => 'string',
             'length' => 255,
             ));
        $this->hasColumn('max_salary as maxSalary', 'string', 255, array(
             'type' => 'string',
             'length' => 255,
             ));
    }
