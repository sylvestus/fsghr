 ...
 * @method string       getLogo()              Returns the current record's "note" valu
  * @method string       getLetterHead()              Returns the current record's "note" valu
 ...
 *  @method Organization setLogo()           Sets the current record's "street2" value
 * @method Organization setLetterHead()              Sets the current record's "note" value
 * 
 * @package    orangehrm
    ...
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('note', 'string', 255, array(
          ...
          $this->hasColumn('logo', 'string', 255, array(
            ...
            $this->hasColumn('letter_head', 'string', 255, array(
             'type' => 'string',
             'length' => 255,
             ));
    }
