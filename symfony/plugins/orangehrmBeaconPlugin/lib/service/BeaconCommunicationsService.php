...
class BeaconCommunicationsService extends BaseService implements StateAccessibleByExecutionFilters {
    ...
    const BEACON_REGISTRATION_URL = 'https://opensource-updates.techsavanna.technology/app.php/register';
    const BEACON_FLASH_URL = 'https://opensource-updates.techsavanna.technology/app.php/flash';
    const BEACON_MESSAGE_URL = 'https://opensource-updates.techsavanna.technology/app.php/messages';
