                ...
                <?php if ($beaconAcceptance != 'on' && $isAdmin) { ?>
                    ...
                    <div id = "registration-section">
                        ...
                        <div id="heartbeatDescription">
                            <p  ><span style="font-family: arial,helvetica,sans-seif;"><span>By enabling the <span>heartbeat</span> you allow</span>&nbsp; TechSavannaHRM to </span><span style="font-family: arial,helvetica,sans-serif;"><span style="font-family: arial,helvetica,sans-serif;">collect statistics about </span>usage in order to improve the user experience and performance. This function runs in the background and periodically sends data to the TechSavannaHRM Portal. THE DATA ARE JUST NUMBER TOTALS AND THEY DO NOT INCLUDE ANY PERSONAL INFORMATION.  Heartbeat tracks the number of users around the world and logs the time it takes to run database queries.</span><br /><br /></p>
                            ...
                            <p><br />Please contact us with any questions or comments at <a href="mailto:legal@techsavanna.technology" target="_blank">legal@techsavanna.technology</a>.</p>
