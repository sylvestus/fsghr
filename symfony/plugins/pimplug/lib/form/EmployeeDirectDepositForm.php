...
class EmployeeDirectDepositForm extends BaseForm {
    ...
    const ACCOUNT_TYPE_CHECKING = 'CURRENT';
    ...
    public function configure() {
        ...
        $this->accountTypes = array('' => '-- ' . __('Select') . ' --',
                             ...
                             self::ACCOUNT_TYPE_CHECKING => __('Current'),
        ...
        $this->setWidgets(array(
            ...
            'bankbranch'=>new sfWidgetFormChoice(array('choices' => OhrmBankBranchTable::hydrateBankBranches())),
        ...
        $this->setValidators(array(
            ...
            'bankbranch'=>  new sfValidatorInteger(),
            'emp_number'=>  new sfValidatorString(),
    ...
    public function getDirectDeposit(&$salary) {
        ...
        if ($accountType == self::ACCOUNT_TYPE_OTHER) {
          ...
          $salary->directDebit->emp_number= $this->getValue('emp_number');  
           $salary->directDebit->bankbranch = $this->getValue('bankbranch');  
          
        $salary->directDebit->routing_num = $this->getValue('routing_num');        
        $salary->directDebit->amount =0;// $this->getValue('amount');        
    }
