...
class EmployeeSalaryForm extends BaseForm {
    ...
    public function getSalaryWidgets() {
        ...
        $widgets['salary_component'] =new sfWidgetFormSelect(array('choices' =>array("Basic Salary"=>"Gross Salary","House Allowance"=>"House Allowance",'other_allowances'=>"Other Allowance")));
        $widgets['comments'] = new sfWidgetFormTextArea();
        $widgets['fileApprove']=new sfWidgetFormInputFile(array('label'=> __('Approval File*')));
    ...
    public function getSalaryValidators() {
        ...
        $validators = array(
            ...
            'fileApprove' => new sfValidatorFile(array('required' =>true,
                'max_size' => 5000000), array('max_size' => __(TopLevelMessages::FILE_SIZE_SAVE_FAILURE))),
