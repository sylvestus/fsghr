...
class EmployeeService extends BaseService {
    ...
    */
    ...
    public function saveEmployeeSalary(EmployeeSalary $salary) {
        $empBasicsalary= $this->getEmployeeDao()->saveEmployeeSalary($salary);
      
        if($empBasicsalary->getSalaryName()=="Basic Salary"){
         
        $empBasicsalary1=new EmployeeSalary();
            $empBasicsalary1->setSalaryName("House Allowance");
              $empBasicsalary1->setPayGradeId($empBasicsalary->getPayGradeId());
              $empBasicsalary1->setEmpNumber($empBasicsalary->getEmpNumber());
              $empBasicsalary1->setCurrencyCode($empBasicsalary->getCurrencyCode());
              $houseallowance=round(0.15*$empBasicsalary->getAmount());
               $empBasicsalary1->setAmount($houseallowance);
               $empBasicsalary1->setPayPeriodId($empBasicsalary->getPayPeriodId());
                $empBasicsalary1->save();  
        }
    ...
    public function saveHouseAllowance(EmployeeSalary $empBasicsalary){
        $empBasicsalary=new EmployeeSalary();
            $empBasicsalary->setSalaryEmployeeSalaryName("House Allowance");
              $empBasicsalary->setPayGradeId($empBasicsalary->getPayGradeId());
              $empBasicsalary->setEmpNumber($empBasicsalary->getEmpNumber());
              $empBasicsalary->setCurrencyCode($empBasicsalary->getCurrencyCode());
              $houseallowance=round(0.15*$empBasicsalary->getAmount());
               $empBasicsalary->setAmount($houseallowance);
               $empBasicsalary->setPayPeriodId($empBasicsalary->getPayPeriodId());
                $empBasicsalary->save();
