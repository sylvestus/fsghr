...
class getEmployeeListAjaxAction  extends sfAction{
	...
	public function execute($request){
        ...
        $properties = array("empNumber","employeeId","firstName", "middleName", "lastName", "termination_id");
        ...
        foreach ($employeeNameList as $id => $attributes) {
            ...
            $jsonArray[$attributes['empNumber']] = array('name' => $name, 'id' => $attributes['empNumber'],'empId'=>$attributes['employeeId']);
        }
