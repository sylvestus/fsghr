    ...
    <div class="inner">
     ...
     <br>
            ...
            <table class="table hover data-table displayTable exporttables tablestatic" id="recordsListTable">
               <tr><td colspan="12" style="text-align:center;font-weight:bold"> MDA SUMMARY REPORT
           ...
           foreach ($employees as $record):  
            ...
            <tr><td colspan="6" style="text-align:center;font-weight:bold"><?=$grade->name?></td>
                <td colspan="6" style="text-align:center;">0</td></tr>
            <?php } ?>
                <tr><td colspan="6" style="text-align:center;font-weight:bold">Total</td>
                <td colspan="6" style="text-align:center;">0</td></tr>
                <tr><td colspan="12" style="text-align:center;font-weight:bold;background-color:#ccc">UPDATES FOR MONTH
                ...
                <tr>
                   ...
                   <tr>
                        <td class="tdName tdValue"><?=$trailrow?>
                        
                        <?php $employeedetails=  EmployeeDao::getEmployeeByNumber($trail["affected_user"]);
               $locationn = HsHrEmpLocationsTable::findEmployeeLocation($trail["affected_user"]);
                        if(empty($locationn)){
                            $locationn="N/A";
                        }
                       ...
                       <?php if($employeedetails->emp_gender==2){echo "Female";}else{echo "Male";}?>    
                        ...
                        <td class="tdName tdValue"><?=$trail['updated_value']?></td>
