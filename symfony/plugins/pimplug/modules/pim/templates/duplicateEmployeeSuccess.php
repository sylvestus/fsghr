...
<div id="recordsListDiv" class="box miniList">
    <div class="head">
        <h1><?php echo __('Duplicate Details  '.$month); ?>&nbsp;&nbsp; </h1>
    ...
    <div class="inner">
     ...
     <br>
            ...
            <table class="table hover data-table displayTable exporttables tablestatic" id="recordsListTable">
                <tr><td colspan="8" style="text-align:center"> <u style="font-weight:bold">EMPLOYEES WITH DUPLICATE IDs</u>
                
                    </td></tr>
            <tr><td>#</td><td colspan="3">Number Of Entries: <?=count($employees)?></td><td></td><td>Period: <?=date("F").",".date("Y")  ?></td><td colspan="2"><?=$page?></td></tr>
            
                  
                    <tr><td colspan="9" class="boldText" style="font-weight:bold"><center>Employer's Name: 
            ...
            <?php echo __("P.O BOX ".strtoupper($organisationinfo->getStreet1()." ".$organisationinfo->getZipCode().", ".$organisationinfo->getCity())); ?>&nbsp;&nbsp; </center></td></tr>
                    <tr>
                       <td class="boldText borderBottom" >#</td>
                        <td class="boldText borderBottom" ><?php echo __('ID No'); ?></td>
                        <td class="boldText borderBottom"><?php echo __('Name'); ?></td>
                        <td class="boldText borderBottom" ><?php echo __('Job Title'); ?></td>
                       <td class="boldText borderBottom" ><?php echo __('Work Station'); ?></td>
                       <td class="boldText borderBottom"><?php echo __('Photo'); ?></td>
                       <td class="boldText borderBottom"><?php echo __('Fingerprint'); ?></td>
       ...
       echo '<img src="data:image/jpeg;base64,'.base64_encode($employee->getPhoto()).'" alt="Employee fingerprint"   height="100" width="150"/>';
...
echo '<img src="data:image/jpeg;base64,'.base64_encode($employee->getFingerprint()).'" alt="Employee fingerprint"   height="100" width="150"/>';
//echo "<img src='data:image/jpeg;base64,".base64_encode($contentsss)."' />";

                                ?>
                            
                        </td>
                        <td class="tdValue" style="text-align:right"><?=$status?></td>
...
$.ajax({
	...
	$('.print').click(function() {
     ...
     $('#pagenumber').change(function() {
		...
		window.location.replace("<?=url_for('pim/duplicateEmployee')?>"+"?limit=500&start="+offset+"&page="+page);
	}); 
