                ...
                <fieldset>
                    ...
                    <ol>
                        <li>
                            ...
                            <?php echo $form['job_title']->render(array("class" => "formSelect")); ?>    <a href="<?=url_for('admin/saveJobTitle?empNumber='.$empNumber)?>">+Add Title</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <?php echo $form['location']->renderLabel(__('MDA')); ?>
                    ...
                    <p>
                        ...
                        if (!empty($empTermination)) {
                            ...
                            if($terminationstatus=="pending"){
                            $btnTitle = __("Activate Employment");
                            $label = __("Terminated on") . " : " . set_datepicker_date_format($empTermination->getTerminationDate()). "<span style='color:orange;font-size:16px'>&nbsp;Approval ".$terminationstatus."</span>";
                            }
                            $label2 = __("Print Termination Letter") . " : " . set_datepicker_date_format($empTermination->getTerminationDate());
                        } else {
                        ...
                        <?php if ($allowActivate) { ?>
                            <label id="terminatedDate">
                                ...
                                <a class="btn3" target="_blank"   href="<?=  url_for('pim/printTermination?id='.$terminatedId)?>" ><?php echo $label2; ?></a>
                            </label>      
                        <?php } else {
...
<div class="modal hide" id="terminateEmployement">
    ...
    <div class="modal-body">
        <form id="frmTerminateEmployement" method="post" enctype="multipart/form-data"
            ...
            <fieldset>
                <ol>
                    ...
                    <li>
                        <?php echo $employeeTerminateForm['date']->renderLabel(__('Termination Date') . ' <em>*</em>'); ?>
                        <?php echo $employeeTerminateForm['date']->render(array("class" => "formDateInput")); ?>
                    </li>
                     <li>
                        <?php echo $employeeTerminateForm['fileApprove']->renderLabel(__('Approval File') . ' <em>*</em>'); ?>
                        <?php echo $employeeTerminateForm['fileApprove']->render(); ?>
                    </li>
                     <li>
                        <?php echo $employeeTerminateForm['payment_date']->renderLabel(__('Payment up to') . ' <em>*</em>'); ?>
                        <?php echo $employeeTerminateForm['payment_date']->render(array("class" => "formDateInput")); ?>
                    </li>
                     <li>
                        <?php echo $employeeTerminateForm['overtime_for_months']->renderLabel(__('Overtime for Months') . ' <em>*</em>'); ?>
                        <?php echo $employeeTerminateForm['overtime_for_months']->render(array("class" => "formTxtInput","placeholder"=>"Hrs")); ?>
                   <?php echo $employeeTerminateForm['overtime_amount']->render(array("class" => "formTxtInput","placeholder"=>"KES")); ?>
                     </li>
                      <li>
                        <?php echo $employeeTerminateForm['pending_leave']->renderLabel(__('Pending Leave Days/Amount') . ' <em>*</em>'); ?>
                        <?php echo $employeeTerminateForm['pending_leave']->render(array("class" => "formTxtInput","placeholder"=>"Days","value"=>$leavebalance)); ?>
                          <?php echo $employeeTerminateForm['pending_leave_amount']->render(array("class" => "formTxtInput","readonly"=>"readonly","value"=>round($leavebalance*$dailyrate))); ?>
                          
                    </li>
                    <li>
                        <?php echo $employeeTerminateForm['one_month_pay']->renderLabel(__('One Month Pay In Lieu of Notice') . ' <em>*</em>'); ?>
                        <?php echo $employeeTerminateForm['one_month_pay']->render(array("class" => "formTxtInput","placeholder"=>"KES")); ?>
                    </li>
                     <li>
                        <?php echo $employeeTerminateForm['service_benefits']->renderLabel(__('Service Benefits/Gratuity') . ' <em>*</em>'); ?>
                        <?php echo $employeeTerminateForm['service_benefits']->render(array("class" => "formTxtInput","placeholder"=>"Years")); ?>
                          <?php echo $employeeTerminateForm['service_benefits_amount']->render(array("class" => "formTxtInput","placeholder"=>"KES")); ?>
                    </li>
                     <li>
                    ...
                    <hr>DEDUCTIONS
                     <li>
                        <?php echo $employeeTerminateForm['notifice_payment']->renderLabel(__('Notifice Payment') . ' <em>*</em>'); ?>
                        <?php echo $employeeTerminateForm['notifice_payment']->render(array("class" => "formTxtInput","placeholder"=>"KES")); ?>
                    </li>
                    <li>
                        <?php echo $employeeTerminateForm['salary_advance']->renderLabel(__('Salary Advance') . ' <em>*</em>'); ?>
                        <?php echo $employeeTerminateForm['salary_advance']->render(array("class" => "formTxtInput","placeholder"=>"KES")); ?>
                    </li>
                     <li>
                        <?php echo $employeeTerminateForm['company_loan']->renderLabel(__('Company Loan') . ' <em>*</em>'); ?>
                        <?php echo $employeeTerminateForm['company_loan']->render(array("class" => "formTxtInput","placeholder"=>"KES")); ?>
                    </li>
