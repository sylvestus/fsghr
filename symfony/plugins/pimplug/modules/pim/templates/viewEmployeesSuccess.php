...
<div id="recordsListDiv" class="box miniList">
    <div class="head">
        <h1><?php echo __('Employee Biometric Details  '.$month); ?>&nbsp;&nbsp; </h1>
    ...
    <div class="inner">
     ...
     <br>
            ...
            <table class="table hover data-table displayTable exporttables tablestatic" id="recordsListTable">
                <tr><td colspan="7" style="text-align:center"> <u style="font-weight:bold">VERIFIED EMPLOYEE LIST</u>
                
                    </td></tr>
            <tr><td>#</td><td colspan="2">Number Of Entries: <?=count($employees)?></td><td></td><td>Period: <?=date("F").",".date("Y")  ?></td><td colspan="2"><?=$page?></td></tr>
            
                  
                    <tr><td colspan="8" class="boldText" style="font-weight:bold"><center>Employer's Name: 
...
$.ajax({
	...
	$('.print').click(function() {
     ...
     $('#pagenumber').change(function() {
		...
		window.location.replace("<?=url_for('pim/viewEmployees')?>"+"?limit=500&start="+offset+"&page="+page);
	}); 
