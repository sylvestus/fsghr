            ...
            <fieldset>
                <ol>
                     <li class="fieldHelpContainer">
                        ...
                        <select name="txtAttDesc">
                           <?php
                               foreach ($filecategories as $filecategory) { ?>
                            <option value="<?php echo $filecategory->category_name ?>"><?php echo $filecategory->category_name ?></option>
                         <?php      }
                           ?>
                        </select>
                    ...
                    <li id="currentFile">
                        <label><?php echo __("Document No")?></label>
                       <input type="text" name="documentno" id="documentno" value=""/>
                    </li>  
                     <li id="expiry">
                        <label><?php echo __("Expiry Date")?></label>
                        <input id="expirydate" type="text" name="document[date]" class="calendar hasDatepicker valid">
                     <img class="ui-datepicker-trigger" src="/ohrm/symfony/web/webres_5523b60dca2e19.91394908/themes/default/images/calendar.png" alt="" title="">
                    </li>  
                    <li class="fieldHelpContainer">
...
<script type="text/javascript">
    ...
    var lang_EditAttachmentHeading = "<?php echo __("Edit Document"); ?>";
    var lang_AddAttachmentHeading = "<?php echo __("Add Document"); ?>";
