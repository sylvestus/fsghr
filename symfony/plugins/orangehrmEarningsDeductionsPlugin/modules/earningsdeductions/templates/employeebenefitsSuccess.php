...
<div class="box searchForm toggableForm" id="employee-information">
    <div class="head">
        <h1><?php echo __("Employee Benefits Information") ?></h1>
    </div>
...
<div id="recordsListDiv" class="box miniList">
 ...
 <div class="inner">
            ...
            <p id="listActions">
                <input type="hidden" id="adddeduction" value="<?php echo url_for('earningsdeductions/AddEmployeeBenefit'); ?>">
                  <input type="hidden" id="deletededuction" value="<?php echo url_for('earningsdeductions/DeleteEmployeeBenefit'); ?>">
                   
                  <input type="hidden" id="updatededuction" value="<?php echo url_for('earningsdeductions/UpdateEmployeesBenefits'); ?>">
                <input type="button" class="addbutton" id="btnAddSlab" value="<?php echo __('Add Employee Benefit'); ?>"/>
                <select id="btnUpdateSlab" class="greenselect">
                      <option value="">Update Employee Benefit</option>
                      <?php foreach ($benefits as $deduction) { 
        ...
        foreach ($pager->getResults() as $record):  
                    ...
                    <tr class="<?php echo $cssClass;?>">
                        ...
                        <td class="tdValue">
                         ...
                         <?php
                          $employeebenefits= EmployeeBenefitsDao::getBenefitByEmpNumber($record->getEmpNumber());
                          $countitems=count($benefits);
                          //compare rows and columns
     for($i=0;$i<$countitems;$i++){
   echo '<td  id="'.$benefits[$i].'">';
            foreach ($employeebenefits as $empearn) { 
                $benefitdetail= BenefitsDao::getBenefitById($empearn->getBenefitId());
                   if(strtolower($benefitdetail->getName())==strtolower($benefits[$i])){
                             
                      echo $empearn->getYearlyAmount();
