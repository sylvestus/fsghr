...
<div id="recordsListDiv" class="box miniList">
    <div class="head">
        <h1><?php echo __('Loan Application Form: '); ?><?=$employee->getEmpFirstname().' '.$employee->getEmpMiddleName().' '.$employee->getEmpLastname()?>&nbsp;&nbsp;  <span style="float:right"><a class="word-export" href="javascript:void(0)"> Export as .doc </a></span></h1>
    ...
    <center class="boldText">STAFF LOAN APPLICATION</center>
  <hr>
<br><br>

<table width="100%">
    <tr>
        <td> First Name   <u><?=$employee->getEmpFirstname()?></u></td> <td width="30%">  Middle Name: <u><?=$employee->getEmpMiddleName()?></u></td>   <td width="40%">Last Name:<u><?=$employee->getEmpLastname()?></u></td></tr>
...
<tr> <td colspan="5"><br><br></td></tr>
<tr>
    <td>Home Department Name: _______________________________________________________________</td><td colspan="4">
...
<tr><td colspan="2">
<br>
Total Loan Amount Requested: <b class="boldText"> KES <?=$loanaccount->getAmountApplied()?></b>
<br><br>           </td></tr>           
