    ...
    <div class="inner" id="addIncomeTaxSlabTbl">
        ...
        <form id="frmAddTax" method="post" action="<?php echo url_for('loans/addLoanProduct'); ?>" 
            ...
            <fieldset>
                ...
                <p>
                    <input type="submit" value="<?php echo __("Save Loan Product"); ?>"/>   <input type="button" id="cancel" class="cancel" value="<?php echo __("Cancel"); ?>"/>
