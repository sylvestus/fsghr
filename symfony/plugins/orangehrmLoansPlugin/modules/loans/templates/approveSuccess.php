...
<?php } else { ?>
    ...
    <div class="head">
        <h1><?php echo __('Loan Approval for '.$member->getFirstName().' '.$member->getMiddleName().' '.$member->getLastName()); ?></h1>
    </div>
    ...
    <div class="inner" id="addIncomeTaxSlabTbl">
        ...
        <form id="frmAddTax" method="post" action="<?php echo url_for('loans/approve?id='.$loanaccount->getId()); ?>" 
              >
            <fieldset>
                <ol>
                ...
                <p>
                    <input type="submit" value="<?php echo __("Approve Loan"); ?>"/>   <input type="button" id="cancel" class="cancel" value="<?php echo __("Cancel"); ?>"/>
