...
<div id="recordsListDiv" class="box miniList">
    <div class="head">
        <h1><?php echo __('Loan Transactions Report  '); ?>&nbsp;&nbsp; </h1>
        ...
        <form name="frmList" id="frmList" method="post" action="<?php echo url_for('loans/viewloan'); ?>">
            ...
            <p id="listActions">
                <input type="hidden" id="filterurl" value="<?php echo url_for('loans/loanTransactions'); ?>">
                   ...
                   <label class="boldText"> Start Date&nbsp;</label><input type="text" class="datepicker" placeholder="YYYY-mm-dd" id="startdate"> &nbsp;&nbsp; <label class="boldText">To Date&nbsp;</label><input type="text" class="datepicker" placeholder="YYYY-mm-dd" id="enddate"> &nbsp;&nbsp;<input type="button" class="addbutton" id="btnfilter" value="<?php echo __('Filter By Date'); ?>"/>
