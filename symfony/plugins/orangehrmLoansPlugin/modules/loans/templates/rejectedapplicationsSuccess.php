...
<div id="recordsListDiv" class="box miniList">
    <div class="head">
        <h1><?php echo __('Rejected Applications '.date("Y")); ?>&nbsp;&nbsp; </h1>
    ...
    <div class="inner">
        ...
        <form name="frmList" id="frmList" method="post" action="<?php echo url_for('loans/reject'); ?>">
            ...
            <p id="listActions">
                <input type="hidden" id="disburseslab" value="<?php echo url_for('loans/reject'); ?>">
                    ...
                    <tr>
                        ...
                        <th ><?php echo __('Loan Type'); ?></th>
                                <th ><?php echo __('Date Applied'); ?></th>
                                 <th ><?php echo __('Amount Rejected'); ?></th>
                                  <th ><?php echo __('Reason Rejected'); ?></th>
           ...
           foreach ($pager->getResults() as $record):  
                    ...
                    <tr class="<?php echo $cssClass;?>">
                        ...
                        <td class="tdValue">
                            <?php echo $record->getRejectionReason(); ?> 
                        </td>
