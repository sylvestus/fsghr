...
<div class="box searchForm toggableForm" id="employee-information">
    ...
    <div class="inner">
        <form id="search_form" name="frmEmployeeSearch" method="post" action="<?php echo url_for('loans/members'); ?>">
           ...
           foreach ($employees as $record):  
                    ...
                    <tr class="<?php echo $cssClass;?>">
                        ...
                        <td class="tdValue">
                         ...
                         <td class="tdValue">
                             <a href="<?=url_for('loans/apply?id='.$record->getEmpNumber());?>">Apply Loan</a>
                        </td>
                    </tr>
