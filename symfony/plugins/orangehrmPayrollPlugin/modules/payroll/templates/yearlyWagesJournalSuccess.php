     ...
     <br>
            ...
            <table class="table hover data-table displayTable exporttable tablestatic" id="recordsListTable">
                <thead>
                    <tr>
                        ...
                        <td class="boldText borderBottom"><?php echo __('Total Deductions'); ?></td>
                                <td class="boldText borderBottom"><?php echo __('Reliefs'); ?></td>
                                <td class="boldText borderBottom"><?php echo __('Net Amount'); ?></td>
                ...
                <tbody>
                    ...
                    <tr><td colspan="6">Clarify If By Location/Department</td></tr>
