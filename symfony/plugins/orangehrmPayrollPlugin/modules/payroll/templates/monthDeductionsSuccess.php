...
<div id="recordsListDiv" class="box miniList">
    ...
    <div class="inner">
        ...
        <?php include_partial('global/flash_messages'); ?>
            ...
            <p id="listActions">
                <input type="hidden" id="filterurl" value="<?php echo url_for('payroll/monthDeductions'); ?>">
        ...
        <a href="#" class="addbutton" style="float:right !important" id="export"><img src="<?php echo "{$imagePath}/excelicon.png"; ?>" /></a>
              ...
              <select class="greenselect"  id="selectdeduction">
                  <option selected="selected">Filter By Deduction</option>
                  <?php
                 $deductions=DeductionsDao::getDeductions();
                 foreach ($deductions as $deduction) {?>
                  <option id="<?=$deduction->getName()?>"><?=$deduction->getName()?></option>      
                 <?php }
                  ?>
              </select>
     <br>
            ...
            <?php echo __(strtoupper($deductionname. ' for  '.$month)); ?>&nbsp;&nbsp; </center></th></tr>
...
$(document).ready(function() {
    $("#emailbtn").click(function(e){
     html=$("#pdftable").html();
     url=$("#pdfurl").val()+"?sendemail=true&report=Monthly Deductions";
$.ajax({
            url: url,
            type: 'post',
            data: {
...
$.ajax({
    ...
    //manage
     $('#selectdeduction').change(function(e) {
         e.preventDefault();
         var selected=$('#selectdeduction :selected').val();
       var url=$("#filterurl").val();
       
       window.location.replace(url+'?selected='+selected);
