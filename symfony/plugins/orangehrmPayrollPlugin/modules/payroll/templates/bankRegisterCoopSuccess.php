    ...
    <div class="inner">
     ...
     <br>
            ...
            <table class="display exporttable dataTables tablestatic" id="recordsListTable">
                <thead>
                                               <th><?php echo __('VOUCTYPE'); ?></th>
                        <th style="text-align:right"><?php echo __('VALUEDET'); ?></th>
                        <th  ><?php echo __('BANKDEBT'); ?></th>
                        <th  ><?php echo __('BRANDEBT'); ?></th>
                        <th  ><?php echo __('ACCOUNTDB'); ?></th>
                        <th ><?php echo __('BANKCRED'); ?></th>
                        <th  ><?php echo __('BRANCRED'); ?></th>
                        <th  ><?php echo __('ACCONTCD'); ?></th>
                        <th  ><?php echo __('ORIGEFE'); ?></th>
                        <th  ><?php echo __('TRANDATE'); ?></th>
                        <th width="9%"><?php echo __('UNIQPRNO'); ?></th>
                        <th width="10%" ><?php echo __('BENENAME'); ?></th>
                          <th  ><?php echo __('USERSIDS'); ?></th>
                    </tr>
                </thead>
                <tbody>
           ...
           foreach ($allslips as $record):  
                    ...
                    <tr>
                        ...
                        <td class="tdName tdValue rightAlign" >
                              <?= $record->getNetPay()?>
                      ...
                      <?= strval($bankdetails["account_number"])?>
                         ...
                         <td class="tdName tdValue" width="9%" >
                          
                             <?= strtoupper($organisationinfo->name)?>
                        </td>
                        ...
                        <td class="tdName tdValue">
                     <?= strtoupper($organisationinfo->province)?>
                        </td>
                         <td class="tdName tdValue" width="9%">
