...
<div id="recordsListDiv" class="box miniList">
    ...
    <div class="inner">
        ...
        <?php include_partial('global/flash_messages'); ?>
            ...
            <p id="listActions">
                <b>BANK TRANSFERS SCHEDULE EQUITY-OB FOR <?php $date=LoanAccountsDao::getMonthFromDate($month); ?><?=$date["month"].",".$date["year"]  ?> </b>
            ...
            <table class="display exporttable dataTables tablestatic" id="recordsListTable">
                <thead>
                    ...
                    <tr> 
                        ...
                        <th width=15%" ><?php echo __('Beneficiary Account No'); ?></th>
                        <th width="15%" ><?php echo __('Beneficiary Name'); ?></th>
                          <th width="10%" ><?php echo __('Local Bank Code'); ?></th>
                          <th width="10%" ><?php echo __('Purpose Code'); ?></th>
           ...
           foreach ($allslips as $record):  
                   ...
                   <td class="tdName tdValue">
                       ...
                       <?= strtoupper($record->getEmpname())?>    
                        ...
                        <td class="tdName tdValue"> <?=$bankdetails["bankcode"].$bankdetails["branchcode"]?></td>
                        <td class="tdName tdValue">OTH</td>
                        <td class="tdName tdValue">
                       <?='KES'?>    
                        </td>
