                    ...
                    <tr>
                     <td  class="tdValue"  style="text-align:right;" width="3%">
                       <?= $count?>   
                           ...
                           $joineddate=$employeedetail->joined_date;
...
//                        $allinterests=$allinterests+$interest;
           ...
           if($location !=$location1){
              ...
              <tr><td class="boldText" colspan="3" style="font-weight:bold">Total Employees: <?=$count-1?></td><td class="boldText" style="font-weight:bold;text-align:right"><?= number_format(array_sum($totalbasic),0)?></td><td class="boldText" style="font-weight:bold;text-align:right"><?=  number_format(array_sum($totalhouse),0)?></td><td class="boldText" style="font-weight:bold;text-align:right"><?=  number_format(array_sum($totalgross),0)?></td><td class="boldText" style="font-weight:bold;text-align:right"><?=  number_format(array_sum($totalnssf),0)?></td><td class="boldText" style="font-weight:bold;text-align:right" ><?=  number_format(array_sum($totalnhif),0)?></td><td class="boldText" style="font-weight:bold;text-align:right"><?=  number_format(array_sum($totalpaye),0)?></td><td class="boldText" style="font-weight:bold;text-align:right"><?=  number_format(array_sum($totalloan),0)?></td><td class="boldText" style="font-weight:bold;text-align:right"><?= number_format(array_sum($totalinterest),0)?></td><td class="boldText" style="font-weight:bold;text-align:right"><?=  number_format(array_sum($totaldeductions),0)?></td><td class="boldText" style="font-weight:bold;text-align:right"><?=number_format(array_sum($totalnet),0)?></td></tr>        
                </tbody>    
