 ...
 *
 */
class tallyAction extends payrollActions {
               ...
               $employeesinlocation["nssf"]=$nssf;
                 $employeesinlocation["nhif"]=$nhif;
                   $employeesinlocation["staff_loan"]=$staffloan;
					 ...
					 //balancing the roundoff act
					 if(floatval($gross)> (floatval($totalnet)+floatval($paye)+floatval($nssf)+floatval($nhif)+floatval($staffloan)+floatval($loaninterest))){
						$diff=floatval($gross)- (floatval($totalnet)+floatval($paye)+floatval($nssf)+floatval($nhif)+floatval($staffloan)+floatval($loaninterest));
						$employeesinlocation["salary"]=$gross-$diff; 
					 }else if(floatval($gross)< (floatval($totalnet)+floatval($paye)+floatval($nssf)+floatval($nhif)+floatval($staffloan)+floatval($loaninterest))){
					     $diff=(floatval($totalnet)+floatval($paye)+floatval($nssf)+floatval($nhif)+floatval($staffloan)+floatval($loaninterest))-floatval($gross);
		                $employeesinlocation["salary"]=$gross+$diff;
					  }else{
						  $employeesinlocation["salary"]=$gross;
					  }
           array_push($compnentsperloc,$employeesinlocation);
		   
		    //function call to post to Tally using $debitac as $location

		          $this->postSalariesToTally($organizationinfo->name,"Salary Staff - ".$employeesinlocation["location"],floatval($employeesinlocation["salary"]),floatval($employeesinlocation["salary_payable"]), 
                            floatval($employeesinlocation["paye"]),floatval($employeesinlocation["nssf"]),floatval($employeesinlocation["nhif"]),floatval($employeesinlocation["staff_loan"]),
							floatval($employeesinlocation["loan_interest"])); 
							
							//unset
							unset($gross);unset($totalnet);unset($paye);unset($nssf);unset($nhif);unset($staffloan);unset($loaninterest);
