 ...
 *
 */
class monthEarningsAction extends payrollActions {
...
//get  last months payroll summery as default
 ...
 $month=$payrollmonth->getPayrollmonth();
       ...
       $employeeearningsdao= new EmployeeEarningsDao();
      ...
      $employees=$employeedao->getEmployeeIdList();
         ...
         foreach ($employees as $empno) {
             if(is_numeric($empno)){
             $employeeearning= $employeeearningsdao->getEmployeeEarningsSumForMonth($empno, $yearmonth);
