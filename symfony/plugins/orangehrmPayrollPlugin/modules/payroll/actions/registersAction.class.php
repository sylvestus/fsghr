 ...
 *
 */
class registersAction extends payrollActions {
...
$searchparams=$post["empsearch"];
      ...
      $employeesinlocation= HsHrEmpLocationsTable::findEmployeesInLocation($location->id);
           ...
           foreach ($employeesinlocation as $empno) {
             ...
             $employeeslip= PayslipTable::getPayslipForMonth($empno, $monthyear);
