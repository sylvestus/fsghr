 ...
 */
class getEmpHouseAllowanceAction extends basePimAction {
  ...
  $basicsalary=HsHrEmpBasicsalaryTable::getEmpBasicSalary($empno);
  
  $houseallowance=round(0*$basicsalary);
  
  echo json_encode($houseallowance);
