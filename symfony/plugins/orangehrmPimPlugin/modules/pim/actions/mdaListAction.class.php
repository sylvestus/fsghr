<?php
//require_once(sfConfig::get("sf_web_dir").'/mpdf/vendor/autoload.php');
 ...
 */
class mdaListAction extends basePimAction {
 ...
 $employees =  EmployeeDao::getAllEmployees($limit,$offset);
 $count=1;
...
$pdf->SetTitle('Mda list');
$pdf->SetSubject('Mda List');
...
catch (Exception $err)
{
    ...
    $trails= EmployeeDao::getAllEmployees(0,2000);
