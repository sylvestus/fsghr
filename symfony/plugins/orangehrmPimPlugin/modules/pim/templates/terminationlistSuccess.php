...
<div id="recordsListDiv" class="box miniList">
    <div class="head">
        <h1><?php echo __('Terminations List'); ?>&nbsp;&nbsp; </h1>
    ...
    <div class="inner">
            ...
            <p id="listActions">
                <input type="hidden" id="filterurl" value="<?php echo url_for('pim/employeelist'); ?>">
                     ...
                     <select name="pageno" id="pagenumber">
                      ...
                      <form action="<?=  url_for('pim/terminationlist')?>">
     ...
     <br>
            ...
            <table class="table hover data-table displayTable exporttables tablestatic" id="recordsListTable">
                <tr><td colspan="11" style="text-align:center"> <u style="font-weight:bold">TERMINATION LIST <?=  strtoupper($locationd)?> FOR <?=$dates?></u>
                
                    </td></tr>
            <tr><td>#</td><td colspan="6">Number Of Entries: <?=count($employees)?></td><td colspan="3">Period: <?=date("F").",".date("Y")  ?></td><td colspan="3"><?=$page?></td></tr>
            
                  
                    <tr><td colspan="11" class="boldText" style="font-weight:bold"><center>Employer's Name: 
            ...
            <?php echo __("P.O BOX ".strtoupper($organisationinfo->getStreet1()." ".$organisationinfo->getZipCode().", ".$organisationinfo->getCity())); ?>&nbsp;&nbsp; </center></td></tr>
                    <tr>
                       ...
                       <td class="boldText borderBottom" style="font-weight:bold"><?php echo __('T.Laruqseyay/Termination Date'); ?></td>
...
$.ajax({
	...
	$('.print').click(function() {
     ...
     $('#pagenumber').change(function() {
		...
		window.location.replace("<?=url_for('pim/terminationlist')?>"+"?limit=500&start="+offset+"&page="+page);
	}); 
