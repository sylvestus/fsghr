...
$info= OhrmOrganizationGenInfoTable::getOrganizationInfo();
//die(print_r($info[0]->letter_head));
$letterhead= sfConfig::get("sf_web_dir")."/uploads/assets/".$info->letter_head;
?>
...
<div id="recordsListDiv" class="box miniList">
    <div class="head">
        <h1><?php echo __('Promotion List'); ?>&nbsp;&nbsp; </h1>
    ...
    <div class="inner">
            ...
            <p id="listActions">
                <input type="hidden" id="filterurl" value="<?php echo url_for('pim/employeelist'); ?>">
                     ...
                     <select name="pageno" id="pagenumber">
                      ...
                      <form action="<?=  url_for('pim/promotionlist')?>">
     ...
     <br>
			...
			<tr><td colspan="13" style="text-align:center"></td></tr>
                <tr><td colspan="13" style="text-align:center"> <u style="font-weight:bold">PROMOTIONS LIST</u>
                
                    </td></tr>
            <tr><td>#</td><td colspan="8">Number Of Entries: <?=count($employees)?></td><td colspan="3">Period: <?=date("F").",".date("Y")  ?></td><td colspan="3"><?=$page?></td></tr>
            ...
            <?php echo __(strtoupper($organisationinfo->getName())); ?> </center></td></tr>
                    <tr>
                       ...
                       <td class="boldText borderBottom" style="font-weight:bold"><?php echo __('Xil hore /Ex Title'); ?></td>
                       <td class="boldText borderBottom" style="font-weight:bold"><?php echo __('Xil danbe/New Title '); ?></td>
                       ...
                       <td class="boldText borderBottom" style="font-weight:bold"><?php echo __('T. Dalacay/Promotion Date'); ?></td>
 ...
 $prev=explode("#",$record['previous_value']);
 echo @$prev[1];
         ?></td>
                       
                          <td class="tdValue" style="text-align:right"><?php 
                          $current=  explode("#",$record['updated_value']);
                          echo $current[1];
                         ...
                         <td class="tdValue" style="text-align:right"><a href='https://<?=$_SERVER['HTTP_HOST']?>/fgshr/symfony/web/uploads/<?=$record["file1"]?>' target="_blank">Ref</a></td>
...
// $.ajax({
   ...
   $("#pdfbtn").click(function(e){
    $(".loader").css("display","block");
	          window.location.replace("<?=url_for('pim/promotionlist')?>"+"?location=0&fromdate=&todate=&pdf=true"); 
	...
	$('.print').click(function() {
     ...
     $('#pagenumber').change(function() {
		...
		window.location.replace("<?=url_for('pim/promotionlist')?>"+"?limit=500&start="+offset+"&page="+page);
	}); 
