        ...
        <div class="inner">
            ...
            <form id="frmEmpContactDetails" method="post" action="<?php echo url_for('pim/contactDetails'); ?>">
                ...
                <fieldset>
                    <ol>
                        <li>
                            <?php echo $form['street1']->renderLabel(__("Poastal Address")); ?>
                            <?php echo $form['street1']->render(array("class" => "formInputText", "maxlength" => 70,'type'=>"number")); ?>
                        </li>
                        <li>
                            <?php echo $form['street2']->renderLabel(__("Street Address")); ?>
