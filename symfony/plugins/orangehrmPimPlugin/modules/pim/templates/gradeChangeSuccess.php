...
<div id="recordsListDiv" class="box miniList">
    <div class="head">
        <h1><?php echo __('Grade Change List'); ?>&nbsp;&nbsp; </h1>
    ...
    <div class="inner">
     ...
     <br>
			...
			<tr><td colspan="11" style="text-align:center"></td></tr>
                <tr><td colspan="11" style="text-align:center"> <u style="font-weight:bold">GRADE CHANGE LIST FOR <?=  strtoupper($locationd)?> FOR <?=$dates?></u>
                
                    </td></tr>
            <tr><td>#</td><td colspan="6">Number Of Entries: <?=count($employees)?></td><td colspan="2" style="text-align:right">Period: <?=date("F").",".date("Y")  ?></td><td colspan="3" style="text-align:right"><?=$page?></td></tr>
            ...
            <?php echo __(strtoupper($organisationinfo->getName())); ?></center></td></tr>
                    <tr>
                       ...
                       <td class="boldText borderBottom" style="font-weight:bold"><?php echo __('Darajo H/Ex. Grade'); ?></td>
                       <td class="boldText borderBottom" style="font-weight:bold"><?php echo __('Darajo Danbe/Current Grade'); ?></td>
           ...
           foreach ($employees as $record):  
               ...
               $location = HsHrEmpLocationsTable::findEmployeeLocation($record["affected_user"]);
                       ...
                       <?php if($employeedetail->emp_gender==2){echo "Female";}else{echo "Male";}?>    
                         ...
                         <td class="tdValue" style="text-align:right"><?=$record['previous_value']?></td>
...
$.ajax({
	...
	$('.print').click(function() {
     ...
     $('#pagenumber').change(function() {
		...
		window.location.replace("<?=url_for('pim/gradeChange')?>"+"?limit=500&start="+offset+"&page="+page);
	}); 
