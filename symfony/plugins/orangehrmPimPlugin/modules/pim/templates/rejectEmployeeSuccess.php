...
<div id="recordsListDiv" class="box miniList">
    <div class="head">
        <h1><?php echo __('Probation Unsuccessful Letter: '); ?><?=$employee->getEmpFirstname().' '.$employee->getEmpMiddleName().' '.$employee->getEmpLastname()?>&nbsp;&nbsp;  <span style="float:right"><a class="word-export" href="javascript:void(0)"> Export as .doc </a></span></h1>
    ...
    <center class="boldText">PROBATION UNSUCCESSFUL</center>
  <hr>
<br><br>
