    ...
    <div class="inner">
        <form id="search_form" name="frmEmployeeSearch" method="post" action="<?php echo url_for('@employee_list'); ?>">
            ...
            <fieldset>
                ...
                <input type="hidden" value="<?=$_SESSION["fname"]?>" id="user">
                <input type="hidden" value="<?=$_SESSION["isAdmin"]?>" id="admin">
                <p>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#btnDelete').click(function() {
              if($("#user").val() !=="Admin" || $("#admin").val() !=="Yes"){
            alert("Not Administrator,Cannot Delete record");
              return false;
        }
