...
<div class="box pimPane">
    ...
    <?php if ($membershipPermissions->canCreate() || ($hasMemDetails && $membershipPermissions->canUpdate())) { ?>
        <div id="addPaneMembership">
            <div class="head">
                <h1 id="membershipHeading"><?php echo __('Add License/Membership'); ?></h1>
            </div>
            ...
            <div class="inner">
                <form name="frmEmpMembership" id="frmEmpMembership" method="post" 
                    ...
                    <fieldset>
                        <ol>
                            <li>
                                <?php echo $form['membership']->renderLabel(__('Licenses/Membership') . ' <em>*</em>'); ?>
    ...
    <div class="miniList" id="listMembershipDetails">
        <div class="head">
            <h1><?php echo __("Assigned Licenses"); ?></h1>
        </div>
                    ...
                    <table id="" class="table hover">
                        <thead>
                            <tr>
                                ...
                                <?php } ?>
                                <th class="memshipCode"><?php echo __("License/Membership"); ?></th>
...
<script type="text/javascript">
    ...
    var addMembershipDetail = '<?php echo __("Add License"); ?>';
    var editMembershipDetail = '<?php echo __("Edit License"); ?>';
