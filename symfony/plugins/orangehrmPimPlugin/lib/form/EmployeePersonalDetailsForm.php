...
class EmployeePersonalDetailsForm extends BaseForm {
    ...
    private function getPersonalInfoWidgets() {
        $widgets = array(
            ...
            'issue_date' => new sfWidgetFormInputText(array(),array("class"=>"datepicker")),
            'expiry_date' => new sfWidgetFormInputText(array(),array("type"=>"number")),
    ...
    private function getPersonalInfoValidators() {
        ...
        $validators = array(
            'txtEmployeeId' => new sfValidatorString(array('required' => true)),
            'txtEmpFirstName' => new sfValidatorString(array('required' => true, 'max_length' => 30, 'trim' => true), array('required' => 'First Name Empty!', 'max_length' => 'First Name Length exceeded 30 characters')),
            'txtEmpMiddleName' => new sfValidatorString(array('required' => TRUE, 'max_length' => 30, 'trim' => true), array('max_length' => 'Middle Name Length exceeded 30 characters')),
            'txtEmpLastName' => new sfValidatorString(array('required' => true, 'max_length' => 30, 'trim' => true), array('required' => 'Last Name Empty!', 'max_length' => 'Last Name Length exceeded 30 characters')),
            ...
            'txtMilitarySer' => new sfValidatorString(array('required' => false)),
             'issue_date' => new sfValidatorString(array('required' => false)),
            'expiry_date' => new sfValidatorString(array('required' => false)),
    ...
    public function getEmployee() {
        ...
        if ($this->personalInformationPermission->canUpdate()) {
            ...
            $employee->pensionable = !empty($smoker) ? $smoker : 0;
