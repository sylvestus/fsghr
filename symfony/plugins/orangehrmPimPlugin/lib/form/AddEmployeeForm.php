...
class AddEmployeeForm extends sfForm {
    ...
    public function configure() {
        ...
        $status = array('Enabled' => __('Enabled'));
        ...
        $empNumber = $idGenService->getNextID(true);
        $employeeId = "SHRD".str_pad($empNumber, 4, '0');

        $this->widgets = array(
//            'firstName' => new sfWidgetFormChoice(array('choices' =>  Ohrm_InterviewTable::hydrateCandidatesFirstName())),
//            'middleName' => new sfWidgetFormChoice(array('choices' =>  Ohrm_InterviewTable::hydrateCandidatesMiddleName())),
//            'lastName' =>new sfWidgetFormChoice(array('choices' =>  Ohrm_InterviewTable::hydrateCandidatesLastName())),
            ...
            're_password' => new sfWidgetFormInputPassword(array(), array("class" => "formInputText passwordRequired", 
                "maxlength" => 20)),
                        ...
                        'on_probation' => new sfWidgetFormSelect(array('choices' =>array("0"=>"NO","1"=>"YES")),array("class" => "formInputText")),
        ...
        $this->setValidators(array(
            'photofile' => new sfValidatorFile(array('max_size' => 10000000, 'required' => false)),
            ...
            'status' => new sfValidatorString(array('required' => false)),
             'on_probation' => new sfValidatorString(array('required' => false))
        ));
    ...
    protected function getFormLabels() {
        $labels = array(
            ...
            'middleName' => false,
            'lastName' => false,
            'fileApprove' => __('Approval File') . '<em id="file_required"> *</em>',
    ...
    public function getEmployee(){
        ...
        $employee->employeeId = $posts['employeeId'];
         $employee->on_probation = $posts['on_probation'];
        return $employee;
    }
