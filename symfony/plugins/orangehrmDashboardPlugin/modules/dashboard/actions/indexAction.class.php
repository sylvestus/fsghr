...
class indexAction extends BaseDashboardAction {
    ...
    public function execute($request) {
        ...
        $this->employeesonprobation=EmployeeDao::getEmployeesOnProbation();
        $this->employeesunsuccessfulprobation=EmployeeDao::getEmployeesProbationUnsuccessful();
        $this->vacancies=Doctrine_Query::create()->from ('OhrmJobVacancy')
             ->where(" `status` =1 ")
      ->fetchArray();
       
          $this->isAdmin = $this->getUser()->getAttribute('user')->isAdmin();
    }
