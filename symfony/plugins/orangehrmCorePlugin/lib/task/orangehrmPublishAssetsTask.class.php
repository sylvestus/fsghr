...
class orangehrmPublishAssetsTask extends sfBaseTask {
    ...
    protected function configure() {
        ...
        $this->briefDescription = 'Publishes web assets of TechSavannaHRM plugins (copy -> no symlinks)';

        $this->detailedDescription = <<<EOF
The [plugin:publish-assets|INFO] Task will publish web assets of TechSavannaHRM plugins.
