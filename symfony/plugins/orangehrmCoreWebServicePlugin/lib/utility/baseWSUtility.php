...
abstract class baseWSUtility {
        protected $webServiceUtilityService;
    
    /**
     *
     * @return WSUtilityService
     */
    public function getWSUtilityService() {
        if (!($this->webServiceUtilityService instanceof WSUtilityService)) {
            $this->webServiceUtilityService = new WSUtilityService();
        }
        return $this->webServiceUtilityService;
    }

    /**
     *
     * @param WSUtilityService $webServiceUtilityService 
     */
    public function setWSUtilityService(WSUtilityService $webServiceUtilityService) {
        $this->webServiceUtilityService = $webServiceUtilityService;
    }
