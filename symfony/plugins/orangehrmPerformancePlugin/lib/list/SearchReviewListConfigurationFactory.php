...
class SearchReviewListConfigurationFactory extends ohrmListConfigurationFactory {
  ...
  $header8= new ManagePerformanceActionHeader();
        ...
        $header5->populateFromArray(array(
            ...
            'elementType' => 'label',
          //  'class'=>'workperiod',
            'elementProperty' => array('getter' => array('getWorkPeriodEnd')),
        ));
         $header6->populateFromArray(array(
            ...
            'sortField' => null,
            'elementType' => 'label',
            'elementProperty' => array('getter' => array('getFinalRate', 'getFinalRate')),
        ));
