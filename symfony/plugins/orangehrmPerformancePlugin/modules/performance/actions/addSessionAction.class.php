 ...
 *
 * */
class addSessionAction extends basePeformanceAction {
 ...
 public function execute($request) {
     ...
     $form=new SessionsForm(array(), $optionsForForm, true);
              $this->setForm($form);
             ...
             // die(print_r($postArray));
                ...
                $_SESSION['trainingsession'] = $postArray;
                     $this->form->bind($request->getParameter($this->form->getName()));
    if ($this->form->isValid()) {
                    $trainingsession=new OhrmTrainingSession();
                   $trainingsession->setTitle($this->form->getValue('title'));
                  $trainingsession->setDate($this->form->getValue('date'));
                $trainingsession->setProject($this->form->getValue('project'));
                $trainingsession->setTrainer($this->form->getValue('trainer'));
                   $trainingsession->setCourse($this->form->getValue('course'));
                   $trainingsession->setStatus($this->form->getValue('status'));
             $trainingsession->save();
                    
                       $this->getUser()->setFlash('success', __('Successfully training session'));
                        $this->redirect('performance/sessions');
