 ...
 *
 * */
class participantsAction extends basePeformanceAction {
 ...
 public function execute($request){
     $session=$request->getParameter("id");
     
   $this->pager = new sfDoctrinePager(OhrmTrainingParticipantsTable::getInstance(), sfConfig::get('app_max_jobs_on_homepage'));
        $this->pager->setQuery(Doctrine::getTable('OhrmTrainingParticipants')->createQuery('a')->where('a.training_session = ?',$session)->orderBy('a.id DESC'));
