 ...
 *
 * */
class traininganalyticsAction extends basePeformanceAction {
 ...
 public function execute($request){
   $this->pager = new sfDoctrinePager(OhrmIncidentsTable::getInstance(), sfConfig::get('app_max_jobs_on_homepage'));
        $this->pager->setQuery(Doctrine::getTable('OhrmIncidents')->createQuery('a')->where('a.id > ?',0)->orderBy('a.date DESC'));
