 ...
 *
 * */
class sessionsAction extends basePeformanceAction {
 ...
 public function execute($request){
   $this->pager = new sfDoctrinePager(OhrmTrainingSessionTable::getInstance(), sfConfig::get('app_max_jobs_on_homepage'));
        $this->pager->setQuery(Doctrine::getTable('OhrmTrainingSession')->createQuery('a')->where('a.id > ?',0)->orderBy('a.id DESC'));
