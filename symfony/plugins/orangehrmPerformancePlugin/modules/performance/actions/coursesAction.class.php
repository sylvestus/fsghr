 ...
 *
 * */
class coursesAction extends basePeformanceAction {
 ...
 public function execute($request){
   $this->pager = new sfDoctrinePager(OhrmTrainingCoursesTable::getInstance(), sfConfig::get('app_max_jobs_on_homepage'));
        $this->pager->setQuery(Doctrine::getTable('OhrmTrainingCourses')->createQuery('a')->where('a.id > ?',0)->orderBy('a.id DESC'));
