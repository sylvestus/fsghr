 ...
 *
 * */
class budgetssetupAction extends basePeformanceAction {
 ...
 public function execute($request){
   $this->pager = new sfDoctrinePager(OhrmBudgetsTable::getInstance(), sfConfig::get('app_max_jobs_on_homepage'));
        $this->pager->setQuery(Doctrine::getTable('OhrmBudgets')->createQuery('a')->where('a.id > ?',0)->orderBy('a.name ASC'));
