...
<div id="recordsListDiv" class="box miniList">
    <div class="head">
        <h1><?php echo __('List Of Training Sessions  '.date("Y")); ?>&nbsp;&nbsp; </h1>
    ...
    <div class="inner">
        ...
        <form name="frmList" id="frmList" method="post" action="<?php echo url_for('loans/viewloan'); ?>">
            ...
            <p id="listActions">
                    ...
                    <input type="hidden" id="pdfurl" value="<?php echo url_for('admin/pdf'); ?>">
                        <input type="hidden" id="addurl" value="<?php echo url_for('performance/addSession'); ?>">
     ...
     <a href="#" class="addbutton" style="float:right !important" id="export"><img src="<?php echo "{$imagePath}/excelicon.png"; ?>" /></a>
      <input type="button" class="addbutton" style="float:right !important" id="btnAddSlab" rel="dvData"  value="<?php echo __('+ Add Training Session') ?>"/>
     <br>
            </p>
            <div id="dvData">
            <table class="display exporttable dataTables tablestatic" id="recordsListTable">
                <thead>
                    ...
                    <tr>
                        ...
                        <td class="boldText borderBottom" width="11%"><?php echo __('Date'); ?></td>
                                <td class="boldText borderBottom" width="11%"><?php echo __('Related Project'); ?></td>
                                
                                 <td class="boldText borderBottom" width="11%"><?php echo __('Course'); ?></td>
                                 <td class="boldText borderBottom" width="11%"><?php echo __('Trainer'); ?></td>
                    ...
                    <tr class="<?php echo $cssClass;?>">
                       ...
                       echo $row+1;
                        ...
                        <td class="tdName tdValue" width="26%">
                            <a href="<?=  url_for('performance/participants?id='.$record->id)?>"><?php  echo $record->title ?></a>    
                        </td>
                     ...
                     echo date("d/m/Y",strtotime($record->date));?>   
                        ...
                        <td class="tdName tdValue" width="11%">
                      <?php  echo $record->project?>   
                        </td>
                           <td class="tdName tdValue"  width="11%">
                       <?php 
                       $course=  OhrmTrainingCoursesTable::getCourse($record->course);
                       echo $course->course_title;
                       
                       ?>  
                        </td>
                           <td class="tdName tdValue"  width="11%">
                       <?php  echo $record->trainer?>  
                        </td>
                             <td class="tdName tdValue"  width="11%">
