...
<div id="recordsListDiv" class="box miniList">
    <div class="head">
        <h1><?php echo __('List of violations'); ?>&nbsp;&nbsp; </h1>
    ...
    <div class="inner">
        ...
        <form name="frmList" id="frmList" method="post" action="<?php echo url_for('performance/violations'); ?>">
          
            <p id="listActions">
           
                    <input type="hidden" id="pdfurl" value="<?php echo url_for('admin/pdf'); ?>">
                        <input type="hidden" id="addurl" value="<?php echo url_for('performance/addViolation'); ?>">
     ...
     <a href="#" class="addbutton" style="float:right !important" id="export"><img src="<?php echo "{$imagePath}/excelicon.png"; ?>" /></a>
      <input type="button" class="addbutton" style="float:right !important" id="btnAddSlab" rel="dvData"  value="<?php echo __('+ Add Violation') ?>"/>
     <br>
            </p>
            <div id="dvData">
            <table class="display exporttable dataTables tablestatic" id="recordsListTable">
                <thead>
                    ...
                    <tr>
                        ...
                        <td class="boldText borderBottom"><?php echo __('Violation'); ?></td>
