...
<div id="recordsListDiv" class="box miniList">
    <div class="head">
        <h1><?php echo __('Budgets List'); ?>&nbsp;&nbsp; </h1>
    ...
    <div class="inner">
                ...
                <input type="hidden" id="viewslab" value="<?php echo url_for('loans/viewloan'); ?>">
                   <input type="hidden" id="repayslab" value="<?php echo url_for('loans/repayloan'); ?>">
                    <input type="hidden" id="pdfurl" value="<?php echo url_for('admin/pdf'); ?>">
                        <input type="hidden" id="addurl" value="<?php echo url_for('performance/addBudget'); ?>">
     ...
     <a href="#" class="addbutton" style="float:right !important" id="export"><img src="<?php echo "{$imagePath}/excelicon.png"; ?>" /></a>
      <input type="button" class="addbutton" style="float:right !important" id="btnAddSlab" rel="dvData"  value="<?php echo __('+ Add Budget') ?>"/>
     <br>
            </p>
            <div id="dvData">
            <table class="display exporttable dataTables tablestatic" id="recordsListTable">
                <thead>
                    ...
                    <tr>
                        ...
                        <td class="boldText borderBottom" ><?php echo __('Title'); ?></td>
                        <td class="boldText borderBottom" ><?php echo __('Period'); ?></td>
                                <td class="boldText borderBottom"><?php echo __('Department'); ?></td>
                                <td class="boldText borderBottom" ><?php echo __('Administered By'); ?></td>
                                 <td class="boldText borderBottom" ><?php echo __('Ceiling(KES)'); ?></td>
                                  <td class="boldText borderBottom" ><?php echo __('Actions'); ?></td> 
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr class="<?php echo $cssClass;?>">
                       ...
                       echo $row+1;
                        ...
                        <td class="tdName tdValue" >
                            <a href="<?=  url_for('performance/budgetexpense?id='.$record->id)?>"> <?php  echo $record->name ?>    </a>
                        </td>
                        <td class="tdName tdValue" >
