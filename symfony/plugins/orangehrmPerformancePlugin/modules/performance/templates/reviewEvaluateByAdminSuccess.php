...
<div id="dvData">
<div class="box" id="divFormContainer" class="printable">
            ...
            <form id="reviewEvaluate" name="reviewEvaluate" method="post" action="">
                ...
                foreach ($form->getReviewers() as $reviewer) {
                                        ...
                                        <div class="evaluationexpand">
                                            <table  class="evaluateBy" >
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php } ?>
                                                    <td><center><input class="rightAlign kpilist" min="<?php echo $rating->getKpi()->getMinRating() ?>" max="<?php echo $rating->getKpi()->getMaxRating() ?>"  type="text" value="<?php echo $rating->getRating(); ?>" id="rating_<?php echo $rating->getId(); ?>"  name="rating[<?php echo $rating->getId(); ?>]" /></center></td>
                    ...
                    <p>
                        ...
                        <a href="#"  class="addbutton print" style="float:right"  id="btnAddSlab" rel="dvData">  <?php echo __('Print') ?></a>&nbsp;&nbsp;
                    </p>
            </form>
...
$("#reviewEvaluation_finalRating").click(function(e){
    var min=0,max=0,value=0;
$(".kpilist").each(function(){
    min=min+parseInt($(this).attr("min"));
    ...
    var average=parseInt((value/max)*20);
$("#reviewEvaluation_finalRating").val(average);
 });
