...
<div id="recordsListDiv" class="box miniList">
    <div class="head">
        <h1><?php echo __('Interview Assesment Paramaters'); ?>&nbsp;&nbsp; </h1>
    ...
    <div class="inner">
        ...
        <form name="frmList" id="frmList" method="post" action="<?php echo url_for('recruitment/addBenchmark'); ?>">
          
            <p id="listActions">
                <input type="hidden" id="addearning" value="<?php echo url_for('recruitment/addBenchmark'); ?>">
                  
                  <input type="hidden" id="updateearning" value="<?php echo url_for('recruitment/UpdateBenchmark'); ?>">
                <input type="button" class="addbutton" id="btnAddSlab" value="<?php echo __('Add Evaluation Criteria'); ?>"/>
                          <input type="button" class="addbutton" id="btnUpdateSlab" value="<?php echo __('Update Evaluation Criteria'); ?>"/>
           ...
           foreach ($pager->getResults() as $record):  
                    ...
                    <tr class="<?php echo $cssClass;?>">
                        ...
                        <td class="tdValue">
                            <?php echo $record->getQuestion() ?> 
                        </td>
                        <td class="tdValue">
                                <?php echo $record->getWeight() ?> 
                        </td>
