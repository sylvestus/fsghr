...
<?php } else { ?>
    ...
    <div class="head">
        <h1><?php echo __('Update Interview Session'); ?></h1>
    </div>
    ...
    <div class="inner" id="addIncomeTaxSlabTbl">
        ...
        <form id="frmAddTax" method="post" action="<?php echo url_for('recruitment/UpdateInterview?id='.$id); ?>" 
              >
            <fieldset>
                <ol>
                ...
                <p>
                    <input type="submit" value="<?php echo __("Update Interview Session"); ?>"/>   <input type="button" id="cancel" class="cancel" value="<?php echo __("Cancel"); ?>"/>
