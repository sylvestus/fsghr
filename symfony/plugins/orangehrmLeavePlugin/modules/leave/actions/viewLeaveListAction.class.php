...
class viewLeaveListAction extends baseLeaveAction {
    ...
    public function execute($request) {
      ...
      // die(print_r($this->getPermissions()));
...
//die($mode);
        //this shows all employees in admin mode
...
$empdao=new EmployeeDao();
            $accessibleEmpIds =$empdao->getEmployeeIdList();// $manager->getAccessibleEntityIds('Employee', null, null, array(), array(), $requiredPermissions);
//die(print_r($accessibleEmpIds));
            if (empty($empNumber)) {
