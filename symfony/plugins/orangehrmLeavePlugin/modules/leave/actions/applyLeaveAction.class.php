...
class applyLeaveAction extends baseLeaveAction {
    ...
    public function execute($request) {
        ...
        if ($request->isMethod('post')) {
         ...
         $leaveapplicationdata=$postArray["applyleave"];
        // die(print_r($postArray));
        
        $employeeNumber=$leaveapplicationdata["txtEmpID"]["empId2"];
       // die($employeeNumber."ccsc");
        //$employeeNumber=126;
            ...
            if ($this->applyLeaveForm->isValid()) {
                ...
                try {
                   ...
                   $leaveParameters->setEmployeeNumber($employeeNumber);
