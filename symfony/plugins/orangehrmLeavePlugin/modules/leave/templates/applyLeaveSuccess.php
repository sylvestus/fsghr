...
<div class="box" id="apply-leave">
    ...
    <div class="inner">
        ...
        <form id="frmLeaveApply" name="frmLeaveApply" method="post" action="">
            <input type="hidden" name="applyleave[txtEmpID][empId2]" id="applyleave_txtEmpID_empId" value="<?=$_SESSION['empID']?>">
...
<div class="modal hide" id="balance_details">
  <div class="modal-header">
    ...
    <h3><?php echo 'TechSavannaHRM - ' . __('Leave Balance Details'); ?></h3>
  </div>
  ...
  <div class="modal-footer">
    ...
    //<![CDATA[        
        ...
        function updateLeaveBalance() {
            ...
            var emp=$("#applyleave_txtEmpID_empId").val();
            ...
            if (leaveType == "") {
                ...
                $.ajax({
                    type: 'GET',
                    url: leaveBalanceUrl,
                    data: '&leaveType=' + leaveType + '&startDate=' + startDate + '&endDate=' + endDate+"&empNumber="+$("#applyleave_txtEmpID_empId").val(),
                    dataType: 'json',
