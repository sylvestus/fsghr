...
<div class="modal hide" id="noselection">
  <div class="modal-header">
    ...
    <h3><?php echo 'TechSavannaHRM - ' . __('No matching employees'); ?></h3>
  </div>
...
<div class="modal hide" id="preview" style="width:500px">
  <div class="modal-header">
    <a class="close" data-dismiss="modal">×</a>
    <h3><?php echo 'TechSavannaHRM - ' . __('Matching Employees'); ?></h3>
  </div>
  <div class="modal-body">
...
<div class="modal hide" id="employeeEntitlement" style="width:500px">
  <div class="modal-header">
    <a class="close" data-dismiss="modal">×</a>
    <h3><?php echo 'TechSavannaHRM - ' . __('Updating Entitlement'); ?></h3>
  </div>
  <div class="modal-body">
