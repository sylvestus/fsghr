    ...
    public function init() {
        ...
        $header7->populateFromArray(array(
          ...
          $header9->populateFromArray(array(
            ...
            'elementProperty' => array(
                'label' =>'Print Form',
                'placeholderGetters' => array('id' => 'getId','empNumber' => 'getEmpNumber'),
                                'urlPattern' => public_path('index.php//directory/leaveForm/leave/{id}/empNumber/{empNumber}')
                
            ),
        ));

        $this->headers = array($header1, $header2, $header3, $header8, $header4, $header5, $header6, $header7,$header9);
    }
