...
class JobTitleDao extends BaseDao {
    ...
    public function getJobTitleList($sortField='jobTitleName', $sortOrder='ASC', $activeOnly = true, $limit = null, $offset = null,$title=null,$description=null) {
        ...
        try {
            ...
            if ($title) {
                $q->addWhere('jobTitleName = ?',$title);
            }
             if ($description) {
                $q->addWhere('jobDescription = ?',$description);
            }
    ...
    public function getJobTitleOnly($jobTitleId) {

           $jobbtitle= Doctrine::getTable('JobTitle')->find($jobTitleId);
       if($jobbtitle){
           return $jobbtitle->getJobTitle();
       }
       else{
           return "";
       }
