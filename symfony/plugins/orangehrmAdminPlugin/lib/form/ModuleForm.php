...
class ModuleForm extends BaseForm {
    ...
    public function configure() {
        ...
        $this->setWidgets(array(
            ...
            'directory' => new sfWidgetFormInputCheckbox(array(), array('class' => 'checkbox', 'value' => 'on')),
              ...
              'loans' => new sfWidgetFormInputCheckbox(array(), array('class' => 'checkbox', 'value' => 'on')),
                   'earningsdeductions' => new sfWidgetFormInputCheckbox(array(), array('class' => 'checkbox', 'value' => 'on'))
        ));        
        ...
        $this->setValidators(array(
            ...
            'directory' => new sfValidatorPass(),
               ...
               'loans' => new sfValidatorPass(),
            'earningsdeductions' => new sfValidatorPass()
    ...
    protected function _getDefaultValues() {
        ...
        $modules = array('admin', 'pim', 'leave', 'time', 'recruitment', 'performance', 'directory','payroll','loans','earningsdeductions');
