...
class JobTitleForm extends BaseForm {
    ...
    public function configure() {
        ...
        if (!empty($this->jobTitleId)) {
            ...
            $this->setDefault('jobTitle',$jobTitle->getJobTitle());
            $this->setDefault('jobDescription', $jobTitle->getjobDescription());
            $this->setDefault('note', $jobTitle->getNote());

//            $this->attachment = $jobTitle->getOhrmJobSpecificationAttachment(); //getJobSpecificationAttachment()
        }
    }
    ...
    public function save() {
        ...
        if (!empty($this->jobTitleId) && is_numeric($this->jobTitleId)) {
            $jobTitleObj = $this->getJobTitleService()->getJobTitleById($this->jobTitleId);
			//die($this->jobTitleId."fdfsd");
         //   $attachment = $jobTitleObj->job_specification_attachment;//getJobSpecificationAttachment();
