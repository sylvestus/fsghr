...
class SystemUserForm extends BaseForm {
    ...
    public function configure() {
        ...
        $modules=array("pms"=>"PMS","stores"=>"STORES","hr"=>"HR");
        ...
        $this->setWidgets(array(
            ...
            'userType' => new sfWidgetFormSelect(array('choices' => $userRoleList), array("class" => "formSelect", "maxlength" => 3)),
               ...
               'modules' => new sfWidgetFormSelect(array('choices' => $modules), array("class" => "formSelect", "maxlength" => 20,"multiple"=>TRUE),array("style"=>"height:100px !important")),
        ...
        $this->setValidators(array(
            ...
            'userType' => new sfValidatorChoice(array('required' => true, 
                    ...
                    'modules' => new sfValidatorChoice(array('required' => true,'choices' => array_keys($modules))),
