 ...
 */
class viewTransactionAction extends baseAdminAction {
    ...
    public function execute($request) {
        ...
        $txnId = $request->getParameter('id');
        $trail=AuditTrailTable::getAuditTrailById($txnId);
        $this->employeedetail=  EmployeeDao::getEmployeeByNumber($trail[0]->affected_user);
        $trails=AuditTrailTable::getAuditTrailByEmployeeId($trail[0]->affected_user);
       // die(print_r($trails));
        $this->trails=$trails;  
