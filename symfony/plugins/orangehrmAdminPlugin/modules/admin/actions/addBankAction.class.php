 ...
 */
class addBankAction extends baseAdminAction {
    ...
    $earnings=new Ohrm_Bank();
    $earnings->setBankName($name);
    $earnings->setBankCode($this->form->getValue('bank_code'));
   
    $earnings->save();
    $this->getUser()->setFlash('success', __('Successfully added bank: '.$name));
