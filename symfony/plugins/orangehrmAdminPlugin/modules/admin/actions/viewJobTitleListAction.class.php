...
//        }
        if ($this->jobTitlePermissions->canRead()) {
            ...
            $description=$request->getParameter('jobDescription');
        // die($title."dds"); 
            $pageNumber = $isPaging;
            ...
            $JobTitleList = $this->getJobTitleService()->getJobTitleList($sortField, $sortOrder, true, $noOfRecords, $offset,$title,$description);
