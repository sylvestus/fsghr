    ...
    <div class="inner" id="addIncomeTaxSlabTbl">
        ...
        <form id="frmAddTax" method="post" action="<?php echo url_for('admin/addBranch'); ?>" >
            <fieldset>
                ...
                <p>
                    <input type="submit" value="<?php echo __("Save Branch"); ?>"/>   <input type="button" id="cancel" class="cancel" value="<?php echo __("Cancel"); ?>"/>
