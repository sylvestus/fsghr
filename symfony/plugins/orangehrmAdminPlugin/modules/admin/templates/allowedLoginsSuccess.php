...
<div id="recordsListDiv" class="box miniList">
    <div class="head">
        <h1><?php echo __('Allowed Users List '.date("Y")); ?>&nbsp;&nbsp; </h1>
    ...
    <div class="inner">
        ...
        <form name="frmList" id="frmList" method="post" action="<?php echo url_for('loans/reject'); ?>">
             ...
             <p id="listActions">
                <input type="hidden" id="addbank" value="<?php echo url_for('admin/addLogins'); ?>">
                  <input type="hidden" id="deletebank" value="<?php echo url_for('admin/deleteLogin'); ?>">
                  <input type="hidden" id="updatebank" value="<?php echo url_for('admin/updateLogin'); ?>">
                <input type="button" class="addbutton" id="btnAddSlab" value="<?php echo __('Add To WhiteList'); ?>"/>
                     <!--     <input type="button" class="addbutton" id="btnUpdateSlab" value="<?php echo __('Update Login'); ?>"/>-->
                <input type="button" class="delete" id="btnDelSlab" value="<?php echo __('Remove From WhiteList'); ?>"/>
           ...
           $employeedetail=  EmployeeDao::getEmployeeByNumber($record->getEmployeeId());
                    ?>
