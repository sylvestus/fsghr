        ...
        <form name="frmLocalization" id="frmLocalization" method="post" action="<?php echo url_for("admin/localization")?>">
            ...
            <fieldset>
                ...
                <ol>
                    ...
                    <li class="helpText">
                        <a href="http://www.techsavanna.technology/localization-help.shtml" target="_blank"><?php echo __('Language and font help'); ?></a>
                    </li>
...
<div class="modal hide" id="languageDialog">
    <div class="modal-header">
        ...
        <h3><?php echo __('TechSavannaHRM - Supported Languages')?></h3>
    </div>
