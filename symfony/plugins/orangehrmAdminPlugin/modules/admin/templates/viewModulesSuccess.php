            ...
            <fieldset>
                ...
                <ol>
                    ...
                    <li class="checkbox">
                     ...
                     <li class="checkbox">
                        <?php echo $form['loans']->renderLabel(__('Enable Payroll Module')); ?>
                        <?php echo $form['loans']->render(); ?>
                    </li>
                      <li class="checkbox">
                        <?php echo $form['earningsdeductions']->renderLabel(__('Enable Earnings/Deductions Module')); ?>
                        <?php echo $form['earningsdeductions']->render(); ?>
                    </li>
                    <li class="required">
