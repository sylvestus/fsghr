...
<div class="modal hide" id="unitDialog">
    <div class="modal-header">
        ...
        <h3 id="title"><?php echo "TechSavannaHRM - " . __("Edit Unit"); ?></h3>
    </div>
...
<script type="text/javascript">
    ...
    var lang_addUnit = "<?php echo "TechSavannaHRM - " . __("Add Unit"); ?>";
    var lang_editUnit = "<?php echo "TechSavannaHRM - " . __("Edit Unit"); ?>";
