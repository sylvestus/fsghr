...
<div id="general-info" class="box twoColumn">
    ...
    <div class="inner">
        ...
        <form name="frmGenInfo" id="frmGenInfo" method="post" action="<?php echo url_for('admin/viewOrganizationGeneralInformation'); ?>" class="clickToEditForm" enctype="multipart/form-data">
            ...
            <fieldset>
                ...
                <ol>
                    ...
                    <li>
                        <?php echo $form['taxId']->renderLabel(__('KRA PIN')); ?>
                    ...
                    <li>
                        <?php echo $form['registraionNumber']->renderLabel(__('Social Security Reg.Number')); ?>
                ...
                <ol>
                    ...
                    <li>
                        <?php echo $form['street1']->renderLabel(__('Address')); ?>
                        <?php echo $form['street1']->render(array("maxlength" => 100)); ?>
                    </li>

                    <li>
                        <?php echo $form['street2']->renderLabel(__('NHIF NO')); ?>
                    ...
                    <li>
                        <label for="organization_Logo">Your Logo</label>    
                        <input type="file" name="organization[logo]"  id="logo">                    </li>
                     <li>
                       
                  <label for="organization_LetterHead">Your Letter Head</label>    <input type="file" name="organization[letter_head]"  id="letter_head">                    </li>
