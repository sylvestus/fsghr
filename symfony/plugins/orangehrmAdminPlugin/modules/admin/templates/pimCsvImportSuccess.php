        ...
        <form name="frmPimCsvImport" id="frmPimCsvImport" method="post" action="<?php echo url_for('admin/pimCsvImport'); ?>" enctype="multipart/form-data">
            ...
            <fieldset>
                ...
                <ol class="normal">
                  ...
                  <ul class="disc">
                    <li>
                        <?php echo __("Column order should not be changed(T.T./Serial No,IDNo,Magaca/Name,Xilka/Job Title,Jinsi/Gender,Derajo/Grade,T.La Qoray/Recruited Date(dd/mm/YYYY),Waaxda/Department,TR.Dhalasho/DOB(dd/mm/YYYY),MDA)"); ?>
                    </li>
                    <li>
                        <?php echo __("Name and ID No fields are compulsory");?>
                    </li>
                    <li>
                    ...
                    <li>
                        <?php echo __("Each import file should be configured for 1000 records or less");?>
                    </li>
                    <li>
